...
function Home() {
	...
	return (
		<div class="container">
			...
			<div class="right">
				<div class="intro">
					Hi! We're Flashfolio! A flashcard website you can use to study to your heart's desire. If you would like to create a deck, please click "Log In." Otherwise, to peruse our large variety of
					public decks, hit "Discover."
				</div>
				<div class="buttons">
